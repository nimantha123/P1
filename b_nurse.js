...
function save(){
    for(i = 0; i < dataLength; i++){
        ...
        if(sample_index !== "" && status !== "Pending"){
            ...
            $.ajax({
                type: "POST",     <!--send a get type request to the server >
                url: baseURL,
                data : JSON.stringify(objecto), <!-- request should be in sason type >
                success : function(data){
                    patientId = undefined; <!-- no need >
